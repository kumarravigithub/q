// FlowRouter.triggers.enter([trackRouteEntry], {except: ["register"]});
//
// function trackRouteEntry(context) {
//     if(! Meteor.userId()) {
//         FlowRouter.go('/loginTwo');
//     }
// }
...
FlowRouter.route('/products', {
    subscriptions: function(params, queryParams) {
        this.register('products', Meteor.subscribe('product_pub'));
    },
    action: function() {
...
FlowRouter.route('/abcdataupload', {
    ...
    action: function() {
        BlazeLayout.render("mainLayout", {content: "abc_data"});
    }
});
...
if(! Meteor.userId() && FlowRouter.getRouteName() != 'loginTwo'){
    FlowRouter.go('/loginTwo');
}
